...
give @a[tag=Wunderbuffe] minecraft:crossbow{display:{Name:'{"text":"ヴンダーヴァッフェ","italic":false}'},Charged:true,ChargedProjectiles:[{Count:1,id:"tipped_arrow",tag:{CustomPotionEffects:[{Id:2,Amplifier:126,Duration:80},{Id:15,Duration:80}],display:{Name:'{"text":"盲目の矢","italic":false}'}}}]} 1